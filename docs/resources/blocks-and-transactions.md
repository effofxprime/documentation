# Beezee Chain Blocks and Transactions

This document describes the block and transaction structure of the Beezee Chain and explains different ways to extract and parse the details of them.

## Table of Content

- [Beezee Chain Blocks and Transactions](#cryptoorg-chain-blocks-and-transactions)
...
- **URL format:** https://mainnet.Beezee:26657/block?height=[height]
...
::: tip Example: Checking the block at height `10000` of the mainnet:
 ...
 [https://mainnet.Beezee:26657/block?height=10000](https://mainnet.Beezee:26657/block?height=10000)

 :::

### 2. Tendermint Block Results API

- **URL format:** https://mainnet.Beezee:26657/block_results?height=[height]
...
::: tip Example: Checking the block result of height `10000` of the mainnet:
 ...
 [https://mainnet.Beezee:26657/block_results?height=10000](https://mainnet.Beezee:26657/block_results?height=10000)
...
- **URL format:** https://mainnet.Beezee:1317/comsos/tx/v1beta1/txs/[Transaction_Hash]
- This API returns the parsed transaction details and events of a particular transaction hash
- **Example**: https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs/0C5E617B0577B047D78EBF5313B8B70DF69E9535E17B964303BD04947B11B660

### 4. Cosmos Transaction Search API

- **URL format:** https://mainnet.Beezee:1317/comsos/tx/v1beta1/txs
- This API support event based query and returns parsed transactions. Common events include:

| Event                           | Description                                                                                                                                            | Example                                                                                                                                                                                                     |
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| tx.height                       | Transaction(s) in a particular block                                                                                                                   | [txs?events=tx.height%3D10000](https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs?events=tx.height%3D10000)                                                                                              |
| message.module & message.action | Search for messages belonged to a particular module and actions. _Note that this index will degrade when more transaction of its kind grows in number_ | [txs?events=message.module%3D%27bank%27&events=message.action%3D%27send%27](https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs?events=message.module%3D%27bank%27&events=message.action%3D%27send%27)    |
| message.sender                  | Search for message with particular signer                                                                                                              | [/txs?events=message.sender=%27cro18undzhe3fmmav2x3csx8m00m5yupkcc7qzz4ec%27](https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs?events=message.sender=%27cro18undzhe3fmmav2x3csx8m00m5yupkcc7qzz4ec%27) |
...
$ cd cosmos-api-tools
$ node block-results-decoder.js "https://mainnet.Beezee:26657/block_results?height=10000"
```
:::
...
In every block, CRO is minted and offered to the active validators and their delegators as block rewards. The actual minted token is subject to inflation and is adjusted every block. Further details on the miniting parameters and configuration can be found [here](https://Beezee/docs/chain-details/module_overview.html#mint).
...
Block proposers can get extra transaction fees bonus for the block they have successfully proposed. More details can be found [here](https://Beezee/docs/chain-details/module_overview.html#transaction-fees-bonus) for reference.
...
Cosmos Transaction Query API: [https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs/0C5E617B0577B047D78EBF5313B8B70DF69E9535E17B964303BD04947B11B660](https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs/0C5E617B0577B047D78EBF5313B8B70DF69E9535E17B964303BD04947B11B660)
...
Cosmos Transaction Query API: [https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs/6CD89C9F32A4F4E918B2BCD722A9429693E3372E3F882BA4A460F2588A2EE0B3](https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs/6CD89C9F32A4F4E918B2BCD722A9429693E3372E3F882BA4A460F2588A2EE0B3)
...
Cosmos Transaction Query API: [https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs/D4FCC8E1403677157D367A88A0832B9E411BDC4E029954FC133DB60296CF3DE3](https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs/D4FCC8E1403677157D367A88A0832B9E411BDC4E029954FC133DB60296CF3DE3)
...
Cosmos Transaction Query API: [https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs/3B36AA1AC81ACD58E7A06C21353DB0FC40A70EDBF6BD2CD23D7BEDC7A0F56318](https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs/3B36AA1AC81ACD58E7A06C21353DB0FC40A70EDBF6BD2CD23D7BEDC7A0F56318)
...
- Cosmos Transaction Query API: [https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs/3739F76EF67A61D6F0163A5B177EA64ED80B67D9AEF8435C525913E69026D320](https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs/3739F76EF67A61D6F0163A5B177EA64ED80B67D9AEF8435C525913E69026D320)
- Message Index: `1`
...
This transaction will trigger an internal transfer from the "Distribution" module account to the withdraw to address. Note that the "Distribution" module account is an internal account in Beezee Chain to hold the rewards, commissions and community pool funds before they are being distributed.

The "Distribution" module account is different on different chain. In Beezee Chain Mainnet, it is [cro1jv65s3grqf6v6jl3dp4t6c9t9rk99cd8lyv94w](https://mainnet.Beezee:1317/cosmos/auth/v1beta1/accounts/cro1jv65s3grqf6v6jl3dp4t6c9t9rk99cd8lyv94w).
...
[https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs/7C1747E0189DCA88BBA55A1720809C8DF6075799C11ECBE4C4E1F89C91D4F55F](https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs/7C1747E0189DCA88BBA55A1720809C8DF6075799C11ECBE4C4E1F89C91D4F55F)

<!-- omit in toc -->

#### Details

This transaction will initiate a transfer from an account to the "Distribution" module account. Note that the "Distribution" module account is an internal account in Beezee Chain to hold the rewards, commissions and community pool funds before they are being distributed.

Ths "Distribution" module account is different on different chain. In Beezee Chain Mainnet, it is [cro1jv65s3grqf6v6jl3dp4t6c9t9rk99cd8lyv94w](https://mainnet.Beezee:1317/cosmos/auth/v1beta1/accounts/cro1jv65s3grqf6v6jl3dp4t6c9t9rk99cd8lyv94w).
...
Cosmos Transaction Query API: https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs/7B3C19A3674C9EF856C43FFF50B021085AC4DA693AA47F82882FFAC78F21DE05
...
Cosmos Transaction Query API: https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs/F4A1D7757AD20979D540C0CD29DD335D17E121F15AA447990B87E0EE94531BD7
...
Cosmos Transaction Query API: [https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs/CCB45B0C6EC18A327ADFC8C36478A163D8C2A8BD9EB13687F73ED3D4559318A3](https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs/CCB45B0C6EC18A327ADFC8C36478A163D8C2A8BD9EB13687F73ED3D4559318A3)
...
Cosmos Transaction Query API: [https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs/5D43A55463C8FB30A89306C26C5E3318826AD075D36E9B5E72F7019C00F14549](https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs/5D43A55463C8FB30A89306C26C5E3318826AD075D36E9B5E72F7019C00F14549)
...
[https://mainnet.Beezee:26657/block_results?height=374823](https://mainnet.Beezee:26657/block_results?height=374823)
...
Cosmos Transaction Query API: [https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs/58BF8EBD17FF9500F395E4A9B2AE93EF21306E5706B3EC31CE116654D78B8684](https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs/58BF8EBD17FF9500F395E4A9B2AE93EF21306E5706B3EC31CE116654D78B8684)
...
Cosmos Slashing Params API: [https://mainnet.Beezee:1317/cosmos/slashing/v1beta1/params](https://mainnet.Beezee:1317/cosmos/slashing/v1beta1/params)
...
Tendermint Block Results API: https://mainnet.Beezee:26657/block?height=[height]
...
Liveness Example: [https://mainnet.Beezee:26657/block_results?height=210356]
...
Double Sign Example: [https://mainnet.Beezee:26657/block_results?height=210356](https://mainnet.Beezee:26657/block_results?height=210356)
...
Cosmos Transaction Query API: https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs/9CCC988616344C804E8831B6FC6BECD6FD0F815E4E3FF13BDE6B7F8360BF0050
...
Cosmos Transaction Query API: [https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs/9CCC988616344C804E8831B6FC6BECD6FD0F815E4E3FF13BDE6B7F8360BF0050](https://mainnet.Beezee:1317/cosmos/tx/v1beta1/txs/9CCC988616344C804E8831B6FC6BECD6FD0F815E4E3FF13BDE6B7F8360BF0050)
...
The latest deposit requirement ("min_deposit") and deposit period ("max_deposit_period") can be checked on https://mainnet.Beezee:1317/cosmos/gov/v1beta1/params/deposit. Note that they are network parameters and may change over time after governance proposals.
...
Tendermint Block Results API: [https://mainnet.Beezee:26657/block_results?height=195346](https://mainnet.Beezee:26657/block_results?height=195346)
...
Tendermint Block Results API:[https://mainnet.Beezee:26657/block_results?height=496620
](https://mainnet.Beezee:26657/block_results?height=496620
)
<!-- omit in toc -->
...
Latest tally params can be retreived from:[https://mainnet.Beezee:1317/cosmos/gov/v1beta1/params/tallying](https://mainnet.Beezee:1317/cosmos/gov/v1beta1/params/tallying). The params may change from time to time after governance proposal.
...
| Module                 | Address                                                                                                                                               |
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| mint                   | [cro1m3h30wlvsf8llruxtpukdvsy0km2kum8s20pm3](https://mainnet.Beezee:1317/cosmos/auth/v1beta1/accounts/cro1m3h30wlvsf8llruxtpukdvsy0km2kum8s20pm3) |
| fee_collector          | [cro17xpfvakm2amg962yls6f84z3kell8c5lgztehv](https://mainnet.Beezee:1317/cosmos/auth/v1beta1/accounts/cro17xpfvakm2amg962yls6f84z3kell8c5lgztehv) |
| distribution           | [cro1jv65s3grqf6v6jl3dp4t6c9t9rk99cd8lyv94w](https://mainnet.Beezee:1317/cosmos/auth/v1beta1/accounts/cro1jv65s3grqf6v6jl3dp4t6c9t9rk99cd8lyv94w) |
| bonded_tokens_pool     | [cro1fl48vsnmsdzcv85q5d2q4z5ajdha8yu3dqpk9x](https://mainnet.Beezee:1317/cosmos/auth/v1beta1/accounts/cro1fl48vsnmsdzcv85q5d2q4z5ajdha8yu3dqpk9x) |
| not_bonded_tokens_pool | [cro1tygms3xhhs3yv487phx3dw4a95jn7t7leqa8nj](https://mainnet.Beezee:1317/cosmos/auth/v1beta1/accounts/cro1tygms3xhhs3yv487phx3dw4a95jn7t7leqa8nj) |
| gov                    | [cro10d07y265gmmuvt4z0w9aw880jnsr700jzemu2z](https://mainnet.Beezee:1317/cosmos/auth/v1beta1/accounts/cro10d07y265gmmuvt4z0w9aw880jnsr700jzemu2z) |
